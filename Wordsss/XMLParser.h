...
enum IterStat_T { TNONE,    TTABLESTRUCTURE, 
    TTABLEDATA,
    TTABLEDATA_WORD, 
    TTABLEDATA_FREQUENCY, TTABLEDATA_FIELD,
    ...
    TTABLEDATA_WORDLIST,
    TTABLEDATA_DOTALISTWORD, TTABLEDATA_CSLISTWORD, TTABLEDATA_MALISTWORD, TTABLEDATA_PHLISTWORD, TTABLEDATA_GRERBLISTWORD, TTABLEDATA_GRERBLISTMEM, TTABLEDATA_TBBTLISTWORD, TTABLEDATA_TBBTLISTSENTENCE, TTABLEDATA_TBBTLISTWORDSENTENCE, 
    TTABLEDATA_LIST,
